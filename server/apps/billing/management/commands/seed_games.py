    ...
    def handle(self, *args, **kwargs):
        ...
        games_data = [
            # FPS / Shooter
            {
                ...
                "working_directory": "C:\\Program Files (x86)\\Steam\\steamapps\\common\\Counter-Strike Global Offensive\\game\\bin\\win64\\"
            },
            {
                "name": "Valorant",
                "category": "FPS",
                ...
                "working_directory": "C:\\Riot Games\\VALORANT\\live\\"
            },
            {
                ...
                "working_directory": "C:\\Program Files (x86)\\Steam\\steamapps\\common\\PUBG\\TslGame\\Binaries\\Win64\\"
            },
            ...
            # Action / Adventure
            {
                ...
                "working_directory": "C:\\Program Files\\Epic Games\\GTA5\\"
            },
            {
                "name": "Cyberpunk 2077",
                "category": "Action",
                ...
                "working_directory": "C:\\GOG Games\\Cyberpunk 2077\\bin\\x64\\"
            },
            {
                ...
                "working_directory": "C:\\Program Files\\Rockstar Games\\Red Dead Redemption II\\"
            },
            ...
            # Sports / Racing
            {
                ...
                "working_directory": "C:\\Program Files\\EA Games\\EA SPORTS FC 24\\"
            },
            {
                ...
                "working_directory": "C:\\Program Files\\EA Games\\NFS Unbound\\"
            },
            {
                "name": "NBA 2K24",
                "category": "Sports",
                ...
                "working_directory": "C:\\Program Files (x86)\\Steam\\steamapps\\common\\NBA 2K24\\"
            },
            ...
            # Strategy / MOBA
            {
                ...
                "working_directory": "C:\\Program Files (x86)\\Steam\\steamapps\\common\\dota 2 beta\\game\\bin\\win64\\"
            },
            {
                ...
                "working_directory": "C:\\Riot Games\\League of Legends\\"
            }
        ]
        ...
        for g_data in games_data:
            ...
            if not created:
                ...
                g.working_directory = g_data["working_directory"]
                g.save()
